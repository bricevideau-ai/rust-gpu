...
#[spirv(kernel)]
pub fn kernel_with_global_id(#[spirv(global_invocation_id)] _id: UVec3) {}

/// Kernel with multiple compute builtins.
#[spirv(kernel)]
pub fn kernel_with_builtins(
    #[spirv(global_invocation_id)] _global_id: UVec3,
    #[spirv(local_invocation_id)] _local_id: UVec3,
    #[spirv(workgroup_id)] _wg_id: UVec3,
    #[spirv(num_workgroups)] _num_wgs: UVec3,
...
pub fn kernel_with_threads(#[spirv(global_invocation_id)] _id: UVec3) {}
